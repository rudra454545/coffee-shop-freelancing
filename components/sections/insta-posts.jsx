...
const posts = [
  { id: 1, image: '/gallery/8.jpg', alt: 'Instagram post 1' },
  { id: 2, image: '/gallery/6.jpg', alt: 'Instagram post 2' },
  { id: 3, image: '/gallery/3.jpg', alt: 'Instagram post 3' },
  { id: 4, image: '/gallery/1.jpg', alt: 'Instagram post 4' }
]
...
export default function InstaPosts() {
  ...
  useEffect(() => {
    ...
    const section = document.querySelector('#insta-posts')
    if (section) {
  ...
  return (
    <section id="insta-posts" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#005f73] mb-4">Follow Us on Instagram</h2>
          <p className="text-xl text-gray-600">Stay updated with our latest creations and behind-the-scenes moments</p>
        </div>
        ...
        <div className="text-center mt-8">
          <a
            href="https://www.instagram.com/shake_sea_?igsh=dWMxNXprejN0YTdz"
            target="_blank"
